...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='TC1/video1.mp4', help='source')  # input video
    parser.add_argument('--output', type=str, default='TC1_output/video1_output', help='output folder')  # output folder
